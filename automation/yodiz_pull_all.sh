...
for yodiz_resource in ${yodiz_resources[@]};do
    ...
    # Dev\Test
    /usr/local/sqream-prerequisites/versions/3.04/bin/python /home/orid/Documents/projects/Yodiz/yodiz.py pull -r $yodiz_resource -tr
    sleep 60
done

# send e-mail test reports 
# Production
#/usr/local/sqream-prerequisites/versions/3.04/bin/python /home/sqream/Documents/Yodiz/yodiz.py mail --inv
...
# Dev\Test
#/usr/local/sqream-prerequisites/versions/3.04/bin/python /home/orid/Documents/projects/Yodiz/yodiz.py mail --sprints 
